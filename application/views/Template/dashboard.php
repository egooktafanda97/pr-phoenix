    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="<?= base_url("assets/template/") ?>index.html"><img src="<?= base_url("assets/template/") ?>assets/images/logo.svg" alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="<?= base_url("assets/template/") ?>index.html"><img src="<?= base_url("assets/template/") ?>assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
            <ul class="nav">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle " src="<?= base_url("assets/template/") ?>assets/images/faces/face15.jpg" alt="">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="Wizard/netletter">
                        <span class="menu-icon">
                            <i class="mdi mdi-speedometer"></i>
                        </span>
                        <span class="menu-title">Buat Surat Baru</span>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="<?= base_url("assets/template/") ?>index.html"><img src="<?= base_url("assets/template/") ?>assets/images/logo-mini.svg" alt="logo" /></a>
                </div>
