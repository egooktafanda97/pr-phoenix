...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url("assets/template/") ?>assets/css/costum.css">
    <!-- End layout styles -->
    <link rel="icon" href="https://monitoring.phoenixkreatifdigital.com/assets/Logo/icons.ico" type="image/x-icon" />
</head>
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="<?= base_url("assets/template/") ?>index.html"><img src="http://phoenixkreatifdigital.com//assets_phoenix_website/images/logo-phoenix.png" alt="logo" /></a>
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="<?= base_url("Wizard") ?>">
                        <span class="menu-icon">
